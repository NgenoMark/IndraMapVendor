...
class _ProjectVendorRegisterPageState
    extends State<ProjectVendorRegisterPage> {
  ...
  final TextEditingController _projectCategoriesController =
      TextEditingController();
  final TextEditingController _companyRegNumberController =
      TextEditingController();
  ...
  Widget _buildRegistrationInfoPage() {
    return Column(
      children: <Widget>[
        _buildTextFormField(_companyRegNumberController, 'Company Registration Number'),
...
void main() {
  runApp(MaterialApp(home: ProjectVendorRegisterPage()));
}
